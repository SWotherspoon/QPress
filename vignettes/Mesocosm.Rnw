...
When this system was subjected to elevated CO$_2$ concentrations in experimental 
...
\begin{figure}[ht]
  ...
  \caption{Model (a) representing the effects of CO$_2$ on the Southern Ocean 
...
\caption{Simulation outcomes in response to a positive press perturbation to
  CO$_2$ for Antarctic mesocosm model (a). Each plot shows the fraction of 
...
increased CO$_2$ concentrations. Given that increases in
...
\begin{figure}[ht]
  ...
  \caption{Alternative model (b) representing the effects of CO$_2$ on the 
...
\caption{Simulation outcomes in response to a positive press perturbation to the
  CO$_2$ for the alternative microbial loop model (b) shown in 
...
\begin{figure}[ht]
  ...
  \caption{Alternative model (c) representing the effects of CO$_2$ on the 
  Southern Ocean  microbial loop.}
...
@
\caption{Simulation outcomes in response to a positive press perturbation to the
  CO$_2$ for the alternative microbial loop model (c) shown in 
